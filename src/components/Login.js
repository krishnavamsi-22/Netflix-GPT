...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form className="w-3/12 absolute p-12 bg-black my-36 mx-auto right-0 left-0 text-white bg-opacity-50">
        <h1 className="font-bold text-3xl py-4 text-red-500">
        ...
        <p className="py-4 cursor-pointer" onClick={toggleSignInForm}>
          {isSignInForm
            ...
            : "Already a User \u{1F680} Sign In"}
        </p>
      </form>
    </div>
  );
